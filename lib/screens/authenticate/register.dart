      ...
      body: Container(
        ...
        child: SafeArea(
          child: Form(
              ...
              child: Column(
                children: [
                  Text('REGISTER',style: TextStyle(fontSize: 30,fontWeight: FontWeight.w500),),
                  SizedBox(height: 20),
                  TextFormField(
                  ...
                  Align(
                    ...
                    child: Column(
                      children: [
                        Text('Already Registered? Sign In',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400),),
                        SizedBox(height: 17),
